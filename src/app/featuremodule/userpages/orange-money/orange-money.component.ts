      ...
      .then((result) => {
        if (result.isConfirmed) {
          ...
          if (user && user.token) {
            ...
            //AFFICHER UNE CANDIDATURE EN FONCTION DE SON ID
            this.serviceFacture
              .AfficherFactureParUuId(this.id)
              .subscribe((data) => {
                this.facture = data;
                ...
                this.photoImmo = data?.bien?.photoImmos;
                if (
                  this.bien.statut.nom === 'A louer' &&
                  this.bien?.periode?.nom === 'Mensuel'
                ) {
                  if (this.facture.mensuel) {
                    ...
                    if (this.bien.avance === 0 && this.bien.caution === 0) {
                      ...
                      this.paiementForm.nombreMois =
                        this.bien.avance + this.bien.caution;
                      // Calculer sommePayer en utilisant le prix du bien multiplié par nombreMois
                      this.paiementForm.sommePayer =
                        this.bien.prix * this.paiementForm.nombreMois;
                    }
                  }
                  ...
                  this.paiementForm.sommePayer =
                    this.bien?.prix * this.contrat?.nombreJour;
                } else if (this.bien?.periode?.nom === 'Hebdomadaire') {
                  this.paiementForm.nombreSemaine = this.contrat?.nombreSemaine;
                  this.paiementForm.sommePayer =
                    this.bien?.prix * this.contrat?.nombreSemaine;
                } else if (
                  this.bien.statut.nom === 'A vendre' &&
                  this.bien?.periode?.nom === 'Mensuel'
                ) {
                  this.paiementForm.sommePayer = this.bien?.prix;
                }
                ...
                this.paiementService
                  .FairePaiement(
                    uuid,
                    this.paiementForm.nombreMois,
                    this.paiementForm.nombreSemaine,
                    this.paiementForm.nombreJours,
                    this.paiementForm.sommePayer,
