...
@Component({
  selector: 'app-candidatures-accepter',
  templateUrl: './candidatures-accepter.component.html',
  styleUrls: ['./candidatures-accepter.component.scss']
})
export class CandidaturesAccepterComponent {
